...
if __name__ == "__main__":
    ...
    print(df[["Length of Stay", "LOS_topcoded", "Facility Redacted"]].head())
    df.to_csv("../data/discharges_clean.csv", index=False)
    print("Saved cleaned file to ../data/discharges_clean.csv")